...
export default function AccountOfflineForm() {
    ...
    return <Row className='justify-content-center column' style={{ margin: '1rem'}}>
                <Jumbotron>
                    <p>In the offline mode you can upload a CSV file and analyse your account without saving any data</p>

...
describe('convertItemToAccountObj', () => {
    ...
    test ('returns an object with correct keys', () => {
        const testCase = {
            user_account_date_amount: { S: 'benyamin.abedian@gmail.com_nabPersonal_1576760400_850.74' },
    ...
    test ('returns the correct values for each key', () => {
        ...
        expect(result['description']).toEqual('15 Wilson Street   BARRY PLANT NOBL')

    ...
    const testCase = [
        {
            user_account_date_amount: {
                S:
                    'benyamin.abedian@gmail.com_cbaPersonalSmart_1586210400_-0.56',
            },
            description: {
                S: 'International Transaction Fee Value Date: 03/04/2020',
            },
        ...
        },
        {
            user_account_date_amount: {
                S:
                    'benyamin.abedian@gmail.com_cbaPersonalSmart_1571835600_-7.7',
            },
            description: {
                S:
                    'KENNYS BAKERY CAFE MELBOURNE VI AUS Card xx3285 Value Date: 22/10/2019',
            },
        ...
        },
        {
            user_account_date_amount: {
                S:
                    'benyamin.abedian@gmail.com_cbaPersonalSmart_1585004400_-1000',
            },
        ...
        {
            user_account_date_amount: {
                S: 'benyamin.abedian@gmail.com_nabPersonal_1565186400_-2492.51',
            },
